    ...
    for cnt in cnt_list:
        ...
        for seed in seed_list:
            for i, fold_i in enumerate(fold_ix_list):
                model_name_i = f"m{mode}_s{seed}_size{cnt}_f{fold_i}"
                ...
                for j, fold_j in enumerate(fold_ix_list):
                    if j > i:
                        model_name_j = f"m{mode}_s{seed}_size{cnt}_f{fold_j}"
                        ...
                        seed_pairs_age.append(np.mean(np.abs(pred_age_i - pred_age_j)))
